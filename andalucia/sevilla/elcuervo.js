// --- Configuración de farmacias (El Cuervo) ---
const pharmacies = {
    yellow: {
        name: "Dña. Fátima Gómez López",
        displayAddress: "C/ Fernando Cámara Gálvez, 46",
        mapsAddress: "Farmacia Fátima Gómez López, El Cuervo, Sevilla",
        phone: "955979510"
    },
    blue: {
        name: "Dña. Concepción Mingorance Martín",
        displayAddress: "C/ Virgen del Castillo, 24",
        mapsAddress: "Farmacia Sánchez Mingorance, El Cuervo, Sevilla",
        phone: "955978348"
    },
    gray: {
        name: "Dña. Celia y Félix Sánchez Sánchez",
        displayAddress: "Avda. Jerez de la Frontera, 70",
        mapsAddress: "Farmacia Sánchez Romero, El Cuervo, Sevilla",
        phone: "955979116"
    },
    red: {
        name: "",
...
const calendarData2025 = {
    enero: [], febrero: [], marzo: [], abril: [], mayo: [],
    junio: [], julio: [], agosto: [], septiembre: [], octubre: [],
    noviembre: ['yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'gray', 'gray', 'gray', 'gray', 'gray', 'gray', 'gray', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'blue', 'blue', 'blue'],
    diciembre: ['blue', 'blue', 'blue', 'blue', 'gray', 'gray', 'gray', 'gray', 'gray', 'gray', 'gray', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'gray', 'gray', 'gray', '', '', '']
};
...
function selectDay(event) {
    ...
    // ✅ CORREGIDO: Soporta los 9 colores
