// --- Configuración de farmacias (Trebujena) ---
const pharmacies = {
    yellow: {
        name: "D. Eulogio Castaño Serradilla",
        displayAddress: "Avda. del Arenal, 2",
        mapsAddress: "Arenal Farmacia, Trebujena, Cádiz",
        phone: "956395351"
    },
    blue: {
        name: "D. Juan Hierro Bustillo",
        displayAddress: "C/ Antonio Machado, 10",
        mapsAddress: "Farmacia calle antonio machado 10, Trebujena, Cádiz",
        phone: "956165376"
    },
    gray: {
        name: "",
...
const calendarData2025 = {
    enero: [], febrero: [], marzo: [], abril: [], mayo: [],
    junio: [], julio: [], agosto: [], septiembre: [], octubre: [],
    noviembre: ['yellow', 'yellow', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow'],
    diciembre: ['blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'blue', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'yellow', 'blue', 'blue', 'blue']
};
